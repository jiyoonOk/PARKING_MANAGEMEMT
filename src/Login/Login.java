...
// TODO 221217 18:30 (다은) 메인화면 비율 변경
public class Login extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (s == "LOGIN") {
			...
			try {
				Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/?user=root", "root", "wldbs1004");//wldbs1004
				...
				id = lgId.getText();
				pw = lgPw.getText();
				strSql = "SELECT * FROM parking.user WHERE id='" + id + "'and passwd = '" + pw + "';";
