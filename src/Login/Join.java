...
public class Join extends JFrame implements ActionListener, ItemListener {
	...
	static boolean is_id_checked, is_find_referral;
		...
		try {
			...
			if (s == "중복확인") {
				...
				if (id.length() < 4 || id.length() > 20 || checkIdMethod(id) != 1) {
					JOptionPane.showMessageDialog(this, "사용 불가능한 id 입니다. 아이디는 영문과 숫자 조합만 가능하며 4~20자리 사이로 입력해주세요!",
							"확인창", JOptionPane.INFORMATION_MESSAGE);
					j_id.setText("");
				...
				if (name.equals("") || id.equals("") || pw1.equals("") || pw2.equals("") || email.equals("")
					...
					JOptionPane.showMessageDialog(this, "아이디 중복확인을 해주세요!", "회원가입 안내창", JOptionPane.INFORMATION_MESSAGE);
				} 
