		...
		try {
			...
			if (s == "중복확인") {
				...
				if (name.equals("") || id.equals("") || pw1.equals("") || pw2.equals("") || email.equals("")
					...
					// 사항 입력
					strSql = "INSERT INTO parking.user(id, passwd, name, email, phone_num, car_num, card_num, referral_id, point )VALUES('"
							+ id + " ',' " + pw1 + " ','" + name + " ',' " + email + "','" + phone + " ','" + carNum
							+ " ',' " + cardNum + "','" + referral_id + " ',' " + 0 + " ');";
					dbSt.executeUpdate(strSql); // sql 질의어 실행
					// 선택 사항 입력
					strSql = "INSERT INTO parking.user_special_needs(id, woman, small_car, handicap)VALUES('" + id + " ',' "
